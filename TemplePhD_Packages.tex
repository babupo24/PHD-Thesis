...
% The remaining packages are not needed for the template, but may be useful to students depending
% on the thesis requirements for their Departments or Colleges.

% For example, science and engineering students may want to turn on the "ams" packages

% Note that these are leftover from previous iterations of Temple PhD's, so some entries are redundant.
% Beware of collisions and ordering if you turn these on.
